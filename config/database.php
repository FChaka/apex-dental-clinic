...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
         * Central (landlord) database — platform admins, clinics registry, subscriptions.
        ...
        /*
         * Template connection for tenant DBs — stancl overwrites the database name per tenant.
         * Same credentials as central; never query tenant data on this connection without initializing tenancy.
         */
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
